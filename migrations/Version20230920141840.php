 ...
 */
final class Version20230920141840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etudiant ADD CONSTRAINT FK_717E22E3FF631228 FOREIGN KEY (etablissement_id) REFERENCES etudiant (id)');
